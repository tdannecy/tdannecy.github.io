...
1.  Navigate to **Start > Computer**. In the top toolbar, click **Map network drive**. ![2016-11-01-mount-drive.png](/sites/KS/team/SiteAssets/Procedure%20Manual/Redacting%20archival%20material%20for%20Duke/2016-04-18_09-41-56.png)
...
Total Commander is faster than the Bulk​ Rename Utility, but it still might take up to an hour to rename all of the files. When the program is finished with the renaming process, it will give you a confirmation message. 
