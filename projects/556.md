...
important than the others. The class noted that it probably 
changes over time. At the moment, privacy issues are the big 
concern. Other students noted that archival representation is 
also a big issue. In a few years, this could change and we 
could value other parts of this Code of Ethics over others.


# October 17, 2016

The professor started the class by discussing the topic of 
...
Other accessioning issues include the timing of the transfer and 
...
1. Record group/manuscript collection (& sub-groups, etc.)
...
The speaker made an interesting point about writing Finding Aid 
...
But at this point, we need to know how to pare things down. The 
